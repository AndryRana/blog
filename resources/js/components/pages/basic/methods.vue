<template>
  <div>
    ...
    <button @click="showItem=!showItem">changed showItem</button>
...
export default {
  ...
  created() {
    ...
    // get blog posts
    let posts = [
      { title: "this is blog title", post: "this is a blog post 1 ", id: 1 },
      { title: "this is blog title", post: "this is a blog post 2", id: 2 },
      { title: "this is blog title", post: "this is a blog post 3", id: 3 },
      { title: "this is blog title", post: "this is a blog post 4", id: 4 },
    ];
